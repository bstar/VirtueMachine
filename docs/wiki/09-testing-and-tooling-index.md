...
- `modern/tools/extract_lzobjblk_savegame.js`: decode canonical `lzobjblk` into mapped `objblk??`
...
- `modern/tools/patch_baseline_profile.js`

## Render/Parity Tests

- `modern/tools/test_client_web_render_composition.sh`
- `modern/client-web/tests/render_composition_fixtures.mjs`
...
- `modern/tools/probe_lb_bedroom.js`
- `modern/tools/report_lb_bedroom_diff.js`
...
- one room changed after restart only -> `reload_net_baseline.js`, world delta inspection
